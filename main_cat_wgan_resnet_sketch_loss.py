...
from model_cat_wgan_resnet_sketch_loss import DTN
from solver_cat_wgan_resnet_sketch_loss import Solver
...
flags.DEFINE_string('source_dir', '/mnt/data_drive/home/ubuntu/datasets/human_128', "directory to source images saved in two pickel files.")
flags.DEFINE_string('target_dir', '/mnt/data_drive/home/ubuntu/datasets/anime_face_128', "directory to target images saved in two pickel files.")
...
flags.DEFINE_integer('hw', 128, "Height and width of input images.")
flags.DEFINE_integer('batch_size', 100, "batch_size")
flags.DEFINE_float('lr', 0.0003,'Learning rate.')
flags.DEFINE_float('alpha', 15.0,'TODO')
flags.DEFINE_float('beta', 15.0,'TODO')
flags.DEFINE_float('gamma', 15.0,'TODO')
FLAGS = flags.FLAGS

def main(_):
    model = DTN(mode=FLAGS.mode, learning_rate=FLAGS.lr, num_classes=FLAGS.num_classes, hw=FLAGS.hw, alpha=FLAGS.alpha, beta=FLAGS.beta, gamma=FLAGS.gamma)
