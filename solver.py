...
class Solver(object):
    ...
    def pretrain(self):
        # load svhn dataset
        train_images, train_labels = self.load_svhn(self.source_dir, split='train')
        test_images, test_labels = self.load_svhn(self.source_dir, split='test')
    ...
    def train(self):
        # load svhn dataset
        svhn_images, _ = self.load_svhn(self.source_dir, split='train')
        mnist_images, _ = self.load_mnist(self.target_dir, split='train')
    ...
    def eval(self):
        ...
        # load svhn dataset
        svhn_images, _ = self.load_svhn(self.source_dir)
